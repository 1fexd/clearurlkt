...
class UrlClearTest {
    ...
    val urls = mapOf(
        ...
        "https://de.statista.com/infografik/amp/22496/anzahl-der-gesamten-positiven-corona-tests-und-positivenrate/"
                to "https://www.google.com/amp/s/de.statista.com/infografik/amp/22496/anzahl-der-gesamten-positiven-corona-tests-und-positivenrate/",
        ...
        "https://example.com/?%3F" to "https://example.com/??",
        "https://example.com/#xxxxxxxxxx%23" to "https://example.com/#xxxxxxxxxx#",
        "https://social.tchncs.de/oauth/authorize?client_id=CLIENT_LEL&redirect_uri=urn%3Aietf%3Awg%3Aoauth%3A2.0%3Aoob&response_type=code&scope=read"
                to "https://social.tchncs.de/oauth/authorize?client_id=CLIENT_LEL&redirect_uri=urn:ietf:wg:oauth:2.0:oob&response_type=code&scope=read",
        "https://minecrafthelp.zendesk.com/requests/9999999999999999999/satisfaction/new/asfdasfasfasfasdasdasdasdasd?locale=1&intention=16"
                to """https://www.google.com/url?q=https://minecrafthelp.zendesk.com/requests/9999999999999999999/satisfaction/
                    |new/asfdasfasfasfasdasdasdasdasd?locale%3D1%26intention%3D16&source=gmail&ust=999999999999999999999&usg=asdafsasfasfasfasfaf""".trimMargin(),
        ...
        "https://bit.ly/3tTxAv4" to """https://lm.facebook.com/l.php?u=
            |https%3A%2F%2Fbit.ly%2F3tTxAv4%3Ffbclid%3DIwAR2BRY7IuBvxCV8OI74v-lWKb0RZAHEmVjfGn2OCRLYJpdrfz2Ow47UqLJc
            |&h=AT1vCA39uUU-mV4NAf7NyueUILrXGPNjF4c1I_YVs6rdBcifbHQI5pVII5W2X4C1ORr01CKJf4VcTV4Mg9xMuz63vj6F-KHHB3OMDASwnc9lEAM8OlU51rVsJNWB_gUhj3K1s401VC4l4_h3E_5R""".trimMargin(),
        """https://ingka.page.link/?link=https%3A%2F%2Forder.ikea.com%2Fat%2Fhistory%2F%23%2Flookup%3ForderId%3Dfuck_you_ikea%26lid%3Dyeeeet
            |&apn=com.ingka.ikea.app&afl=https%3A%2F%2Forder.ikea.com%2Fat%2Fde%2Fpurchases%2Fikea_sucks%2F%3Flid%3Dyeeeet&ibi=com.ing""".trimMargin()
                to """https://ingka.page.link/?link=https://order.ikea.com/at/history/%23/lookup?orderId%3Dfuck_you_ikea%26lid%3Dyeeeet
                    ...
                    |&ofl=https://order.ikea.com/at/de/purchases/ikea_sucks/?lid=yeeeet&imv=14.88.69&amv=8869""".trimMargin(),
        """https://m.facebook.com/v16.0/dialog/oauth?cct_prefetching=0&client_id=cringe&cbt=lol&e2e=xd&ies=0&sdk=android-16.1.3
            ...
            |&default_audience=friends&login_behavior=NATIVE_WITH_FALLBACK&redirect_uri=fbconnect%3A%2F%2Fnö&auth_type=rerequest
            |&response_type=id_token%2Ctoken%2Csigned_request%2Cgraph_domain&return_scopes=true&code_challenge=facebook_sucks""".trimMargin()
                to """https://m.facebook.com/v16.0/dialog/oauth?cct_prefetching=0&client_id=cringe&cbt=lol&e2e=xd&ies=0
                    ...
                    |&return_scopes=true&code_challenge=facebook_sucks""".trimMargin(),
        "https://analyticsindiamag.com/iit-bombay-joins-ibm-meta-to-form-ai-alliance-challenging-openai-google-amazon-microsoft/"
                to """https://analyticsindiamag.com/iit-bombay-joins-ibm-meta-to-form-ai-alliance-challenging-openai-google-amazon-microsoft/
                    |?utm_source=rss&utm_medium=rss&utm_campaign=iit-bombay-joins-ibm-meta-to-form-ai-alliance-challenging-openai-google-amazon-microsoft""".trimMargin(),
        ...
        "https://myanimelist.net/v1/oauth2/authorize?client_id=xd&code_challenge=lule123&response_type=code"
                to """https://myanimelist.net/v1/oauth2/authorize?client_id=xd&code_challenge=lule123&response_type=code""",
        """https://accounts.nintendo.com/connect/1.0.0/authorize?state=aGb6tyEy1VlsoOh96xsttpK2jg7FlqM0EmI5ovlSDrOEDIkSz7
            ...
            |&session_token_code_challenge=SPD1LQJgsnzwrjn54g3DYZZ96sEWAYmLVhEUpLDoUw7&session_token_code_challenge_method=S256""".trimMargin()
                to """https://accounts.nintendo.com/connect/1.0.0/authorize?state=aGb6tyEy1VlsoOh96xsttpK2jg7FlqM0EmI5ovlSDrOEDIkSz7
                    |&redirect_uri=npfd123dc2adf715a15%3A%2F%2Fauth&client_id=d123dc2adf715a15&lang=en-US
                    |&scope=openid+user+user.birthday+user%3AanyUsers%3Apublic+mission+missionStatus+missionCompletion+members
                    |%3Aauthenticate+userGift%3Areceive+pointWallet+rewardStatus+rewardExchange%3Acreate&response_type=session_token_code
                    |&session_token_code_challenge=SPD1LQJgsnzwrjn54g3DYZZ96sEWAYmLVhEUpLDoUw7&session_token_code_challenge_method=S256""".trimMargin()
